...
public class CombinedBlueRight extends AutoControlsCombined {
    ...
    public void runOpMode() {
        ...
        if (spikeLocation == 1) {
            ...
            driveOne.add(new Drive(new MillisecondTrigger(0), 29, 0.5, 0));
            ...
            driveOne.add(new CatWalk(new IndexTrigger(5, driveOne), 0, -20.5, 0.4, 270, 1.2, new Vision(), 1));
            ...
            driveOne.add(new MoveHoist(new MillisecondTrigger(0), hoist.hoistedPosition));
            driveOne.add(new Drive(new MillisecondTrigger(0), 40, 0.5, 0));
            //driveOne.add(new CatWalk(new MillisecondTrigger(0), 40, 5, 0.3, 0, 0.5, new Vision(), 1));
            ...
            driveOne.add(new Drive(new IndexTrigger(4, driveOne), -2, 0.4, 270));*/
        }
        driveOne.Start(0);
        if (spikeLocation == 3) {
            StrafeWithInchesWithCorrection(6, 0.3, -1, 0);
            spike.DropSpike();
            hoist.SetPosition(hoist.stackPosition5);
            DriveWithCorrection(6, 0, 0.3);
            DriveWithCorrection(-2, 270, 0.3);
        }
        if (spikeLocation == 1) {
            DriveAtAngleToStack(22, 0.3);
        }
        if (spikeLocation == 2) {
       ...
       //Strafe on backboard
       if (spikeLocation == 1) {
           StrafeWithInchesWithCorrection(27, 0.25, 1, 270);
       }
       if (spikeLocation == 2) {
            StrafeWithInchesWithCorrection(25, 0.25, 2, 270);
       }
       if (spikeLocation == 3) {
            StrafeWithInchesWithCorrection(39, 0.25, 3, 270);
       }
       DriveWithCorrection(-10, 270, 0.4);
       ...
       Motion driveThree = new Motion();
            ...
            if (spikeLocation == 3) {
                driveThree.add(new CatWalk(new IndexTrigger(2, driveThree), 85, -15, 0.5, 270, 0.5, new Vision(), 1));
