...
public class CombinedRedLeft extends AutoControlsCombined {
    ...
    public void runOpMode() {
        ...
        if (spikeLocation == 1) {
            ...
            driveOne.add(new CatWalk(new IndexTrigger(5, driveOne), 0, 20.5, 0.4, 90, 1.2, new Vision(), 0.5));
       ...
       if (spikeLocation == 3) {
            previousStrafe = StrafeWithInchesWithCorrection(32, -0.25, 6, 90);
       }
       ...
       Motion driveThree = new Motion();
            ...
            driveThree.add(new MoveLift(new IndexTriggerWithDelay(0, 1500, driveThree), lift.liftBottom, lift.liftLow - 4));
